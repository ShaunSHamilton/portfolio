...
import { clusterApiUrl, Connection, PublicKey, Transaction,
// SystemProgram,
 } from "@solana/web3.js";
...
export const createTransaction = async (req, res) => {
    try {
        ...
        const transferInstruction = createTransferCheckedInstruction(buyerUsdcAddress, usdcAddress, // This is the address of the token we want to transfer
        shopUsdcAddress, buyerPublicKey, bigAmount.toNumber() * 10 ** usdcMint.decimals, usdcMint.decimals // The token could have any number of decimals
        );
